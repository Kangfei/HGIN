...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_ckpt_dir', type=str, default='/apdcephfs/private_coffeezhao/PycharmProjects/DDGPredictor2/ckpt/skempi/BertMuPIPR/')
    parser.add_argument('--input_data', type=str, default="/apdcephfs/share_1364275/kfzhao/Bio_data/PNAS_data/skempi.pk")
    #parser.add_argument('--save_ckpt_dir', type=str, default='/apdcephfs/private_coffeezhao/PycharmProjects/DDGPredictor/ckpt/evision/BertMuPIPR/')
    ...
    train_dataset = DDGDataset(train_data, args.num_neighbors, args.mode, tokenizer=embed_tokenizer)
    train_dataloader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, collate_fn=PaddingCollate())
    val_dataset = DDGDataset(val_data, args.num_neighbors, args.mode, tokenizer=embed_tokenizer)
