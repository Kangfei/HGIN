...
from scripts.train_multitask import evaluate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='/apdcephfs/private_coffeezhao/PycharmProjects/DDGPredictor2/ckpt/egnn_pipool/model_400.pt')
    ...
    parser.add_argument('--res_save_path', type=str, default='/apdcephfs/private_coffeezhao/PycharmProjects/DDGPredictor2/result/skempi/EGNN_model_150.csv')
    parser.add_argument('--method', type=str, default='GeoPPI') # method string saved in result file
    ...
    parser.add_argument('--test_input_data', type=str, default="/apdcephfs/share_1364275/kfzhao/Bio_data/PNAS_data/Independent_bbk.pk")
